...
public abstract class Triennial : SmartEnum<Triennial>
{
	...
	*/
	...
	private sealed class Gen_01SE : Triennial
	{
		...
		public override string NameUrl => NameUrl;
		public override string AhavtaURL => "http://www.ahavta.org/Commentary Y-1/Y1-01.htm"; //public override string AhavtaURL => "http://www.ahavta.org/Commentary Y-1/Y1-02.htm";
		public override string Meaning => "In the beginning";
		public override VerseRange TorahVerse => new VerseRange(BibleBook.Genesis, "1:2-3", 1, 34);
		public override List<VerseRange> HaftorahVerses =>
	[
		new VerseRange(BibleBook.Isaiah, "45:17", 18579, 18579),
];
	...
	*/
	...
	private sealed class Gen_08bSE : Triennial
	{
		...
		public override string NameUrl => NameUrl;
		public override string AhavtaURL => "http://www.ahavta.org/Commentary Y-1/Y1-08.htm";
