...
public abstract class Triennial : SmartEnum<Triennial>
{
	...
	//	get
	//	{
	//		return $" {BibleBook.FromValue(this.TorahVerse.BibleBook).Name} {this.TorahVerse.ChapterVerse} {Constants.DaysFromOrToShabbat(this.Date).ToString()}";
	//	}
	//}
	...
	public string Haftorah
	{
		get
		{
			return HaftorahVerses is not null ? String.Join(delim, HaftorahVerses.Select(s => s.BibleBook.Title + " " + s.ChapterVerse)) : ""; // s.BibleBook.Name
		}
	}
	...
	public string Brit
	{
		get
		{
			return BritVerses is not null ? String.Join(delim, BritVerses.Select(s => s.BibleBook.Title + " " + s.ChapterVerse)) : ""; // s.BibleBook.Name
		}
	}
